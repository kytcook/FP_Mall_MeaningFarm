       ...
       <table class="table table-hover">
		<thead>
			...
			<tr>
				...
				<a href="/notice/read?notice_no=${list.notice_no}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}"><c:out value="${list.notice_title}" /></a>
				</td>
