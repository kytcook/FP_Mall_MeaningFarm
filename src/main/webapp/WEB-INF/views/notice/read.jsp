...
<body>
	...
	<button type="button" class="btn btn-success mr-3 " onclick="location.href='mall/notice/read?notice_no=${move.last}'"> <span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span>다음글</button>
	<a href="/mall/notice/read?notice_no=${move.last}" style="color: black"> ${move.lasttitle} </a>
	</c:when>
