...
<body>
	...
	<button type="button" class="btn btn-success mr-3 mb-3" onclick="location.href='/notice/reaView?notice_no=${move.next}'"> <span class="glyphicon glyphicon-menu-up" aria-hidden="true"></span>이전글</button>
		<a href="/notice/read?notice_no=${move.next}" style="color: black"> ${move.nexttitle} </a>
	</c:when>
	...
	<button type="button" class="btn btn-success mr-3 " onclick="location.href='/notice/read?notice_no=${move.last}'"> <span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span>다음글</button>
	<a href="/notice/read?notice_no=${move.last}" style="color: black"> ${move.lasttitle} </a>
	</c:when>
