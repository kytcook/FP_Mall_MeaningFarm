			...
			<form action="/notice/register" method="post">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						...
						<tr>
							<td><textarea type="text" class="form-control" placeholder="글 내용"  id="NOTICE_CONTENT"name="NOTICE_CONTENT" style="height: 350px"></textarea></td>					
						</tr>
					</tbody>
				</table>
				 <button type="submit" class="btn btn-primary">Submit</button>
                 <button type="reset" class="btn btn-danger">Reset</button>
 				<button type="button" class="btn btn-secondary" style="float: right">List</button>    
			</form>
		</div>
	</div>
