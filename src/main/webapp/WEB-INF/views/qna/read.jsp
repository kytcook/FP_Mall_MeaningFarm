...
<body>
			...
			<div id="replyInput" class="container">
				<div>
					<label for="writer">댓글 작성자</label><input type="text"
						class="form-control" id="admin_name" name="admin_name" /> <br />
	...
	<script>
	  $(".replyUpdate").click(function(){
	   self.location = "/qna/replyUpdate?qna_no=${read.qna_no}"
	    + "&page=${scri.page}"
	  ...
	  $(".replyDelete").on("click", function(){
			location.href = "/qna/replyDeleteView?qna_no=${read.qna_no}"
				+ "&page=${scri.page}"
				+ "&perPageNum=${scri.perPageNum}"
				+ "&searchType=${scri.searchType}"
				+ "&keyword=${scri.keyword}"
