  ...
  <div class="container marketing">
    ...
    <div class="row">
      <div class="col-lg-4 border border-info rounded">
        ...
        <rect width="100%" height="100%" fill="#777" style=stroke:red img="./img/savemoney.png"/>
        <text x="50%" y="50%" fill="#777" dy=".3em" img src="/img/savemoney.png">140x140</text></svg>

        <h2 class="fw-normal">절약하세요!</h2>
      ...
      <div class="col-lg-4 border border-info rounded">
        ...
        <h2 class="fw-normal">환경을 지켜주세요</h2>
