...
public class RecipeController {
	...
	public String delete(@ModelAttribute RecipeVO recipeVO, Model model) throws Exception{
		logger.info("delete");
		model.addAttribute("delete", service.read(recipeVO.getRecipe_no()));
		//service.delete(recipeVO.getRecipe_no());
		//redirectAttributes.addFlashAttribute("msg", "delSucess");
...
*/
   //댓글 작성
	...
	public String replyWrite(RecipeReplyVO rrVO, RedirectAttributes rttr) throws Exception{
